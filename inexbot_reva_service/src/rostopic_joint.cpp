...
//pthread_mutexattr_setpshared(&mutexattr, PTHREAD_PROCESS_SHARED);
   ...
   //sem_init( &sem_joint, 1, 0 ) ; 
    ...
    serAddr.sin_port=htons(atoi("4100"));
...
ros::Subscriber sub = n.subscribe("/probot_anno/arm_joint_controller/follow_joint_trajectory/goal", 10000, execute);  
...
ros::init(argc, argv, "publisher"); 
 ...
 //ros::Rate loop_rate(2);
	...
	joint_state.name[0]="robot_joint1";
  
	joint_state.name[1] ="robot_joint2";

	joint_state.name[2] ="robot_joint3";

        joint_state.name[3] ="robot_joint4";

	joint_state.name[4] ="robot_joint5";

	joint_state.name[5] ="robot_joint6";
